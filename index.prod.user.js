...
let active = false;
function activateTab(a, tabWrapper, tabTextWrapper, tabText, tabLineWrapper) {
    return async (e) => {
        e.preventDefault();
...
async function addTab() {
    ...
    tabText.classList.add("CoreText-sc-cpl358-0", "ScTitleText-sc-1gsen4-0", "fiLmJS", "gasGNr", "tw-title");
    tabText.innerText = tabTexts.inactive;
    const tabTextWrapper = document.createElement("div");
    tabTextWrapper.appendChild(tabText);
    tabTextWrapper.classList.add("ScTextWrapper-sc-18v7095-1", tabTextWrapperClassName.inactive);
    ...
    a.classList.add("ScInteractive-sc-18v7095-0", "kMHbQR", "InjectLayout-sc-588ddc-0", "dgbOCY");
    a.onclick = activateTab(a, tabWrapper, tabTextWrapper, tabText, tabLineWrapper);
    const li = document.createElement("li");
    li.appendChild(a);
    li.setAttribute("role", "presentation");
    li.dataset.index = "2";
    li.classList.add("InjectLayout-sc-588ddc-0", "cZIUCO");
    const tabList = await wait_for_the_element_a("#twilight-sticky-header-root ul");
